...
export const PassageControls = (props) => {
  return (
    <nav className="passage_controls">
      <ul>
        <li className="passage_controls--listitem"><button className="button_left" onClick={props.leftClickHandler} /></li>
      ...
      <button className="passage_controls--inventory--toggle" onClick={props.inventoryClickHandler}>Inventory</button>
    </nav>
  );
};
